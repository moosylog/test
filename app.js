...
export const App = {
    ...
    handleWorkerResponse: (e) => {
        const { success, finalOutput, state, layerCount, tapDanceCount, modMorphCount, macroCount, detectedBoard, targetBoard, error, stack } = e.data;
        ...
        UI.buildReport(layerCount, tapDanceCount || 0, modMorphCount || 0, macroCount || 0, state);
